...
def create_single_application_pdf(output_path, applicant_name, applicant_id, vacancy_name, num_pages=2):
...
def create_combined_pdf(output_path, applications_data):
...
def generate_test_fixtures():
    ...
    with open(fixtures_dir / "empty.pdf", 'wb') as f:
        PdfWriter().write(f)
